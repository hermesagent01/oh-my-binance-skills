...
description: Where independent signals agree - evidence-first confluence scan.
---

# confluence-engine (bundle)
...
## Trigger
`Where are several independent signals agreeing?` (symbol or scan mode)
...
## Output format
CONFLUENCE REPORT
per symbol: checklist WITH evidence lines
SCORE: n/checks (evidence first, score second)
TOP CONFLUENCE SETUPS: ranked
FALSIFIERS: what kills each
