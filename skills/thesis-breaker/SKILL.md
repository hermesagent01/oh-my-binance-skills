...
license: MIT
name: thesis-breaker
description: Actively try to disprove a thesis with everything available.
---

# thesis-breaker

Attack a thesis; report surviving core honestly.
...
## Method
Seek contradicting data (market data + web search + historical analogy).
Rank attacks by force. Verdict: SURVIVES | WEAKENED | BROKEN.

## Output contract (use these exact section headers)
THESIS UNDER ATTACK
ATTACKS: strongest-first, each with evidence
SURVIVING CORE: what remains true even if attacks land
