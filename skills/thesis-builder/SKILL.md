...
license: MIT
name: thesis-builder
description: Turn an idea into an evidence-based falsifiable thesis.
---

# thesis-builder

Assemble support, define invalidation precisely.
...
## Method
Assemble supporting evidence -> state thesis ->
define INVALIDATION exactly (price/condition/event) -> define confirmation tracking.

## Output contract (use these exact section headers)
THESIS: statement
SUPPORTING EVIDENCE: ranked
INVALIDATION: exact falsifiable condition
CONFIRMATION TRACKING: what to monitor
