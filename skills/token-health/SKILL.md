...
license: MIT
name: token-health
description: Liquidity, volume quality and overall tradability health of a token.
---

# token-health

Is this token tradable and healthy, or thin and manipulated?
...
## Method
1. Order book depth top-20 levels on primary pair.
2. Volume vs 30d average from klines.
3. Spread on primary pair; volume/mcap sanity ratio.

## Output contract (use these exact section headers)
TOKEN HEALTH - $SYMBOL
LIQUIDITY: depth +/-2%, spread, main venues
VOLUME QUALITY: 24h vs 30d avg (x), trend
FLAGS: thin book / wash-volume suspicion / listing gaps
VERDICT: HEALTHY | ACCEPTABLE | DEGRADED
...
```
node vendors/binance-web3/query-token-info + crypto-market-rank/scripts/cli.mjs meta + token-rank '{"keyword":"..."} / {"category":"marketcap","chainId":"56"}'
```
