---
name: data-integrity
description: Use before major research to validate Binance Agent OS evidence freshness, coverage, consistency and availability.
author: Oh My Binance contributors
license: MIT
metadata:
  hermes:
    tags: [crypto, research, data-quality, binance-agent-os]
---
...
2. asset/contract/chain identity
3. venue and market type
4. missing/stale/conflicting fields
5. baseline sufficiency
6. Binance-native validity flags
