...
license: MIT
name: move-explainer
description: Explain why something moved: multi-dimensional investigation, not one hallucinated reason.
---

# move-explainer

Investigate a move across volume, derivatives, whales, narrative.
...
## Inputs
Symbol (+ optional % threshold)

## Method
Gather for THIS symbol: volume-analysis, open-interest-analysis,
funding-analysis, whale-analysis, liquidation-analysis, narrative-analysis.
Rank contributors by evidence strength.

## Output contract (use these exact section headers)
WHY $SYMBOL MOVED
MOVE: size, window
EVIDENCE BY DIMENSION: finding + weight each
MOST LIKELY CONTRIBUTORS: ranked 1..3
CONFIDENCE + CONTRADICTING DATA
