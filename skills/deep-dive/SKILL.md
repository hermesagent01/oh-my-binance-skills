...
license: MIT
name: deep-dive
description: Everything relevant on one subject, dynamically chosen - AI research analyst mode.
---
...
## Output format
DEEP DIVE - $SUBJECT
All applicable dimensions (orchestrator picks which apply)
THESIS + INVALIDATION
SCENARIOS + HISTORICAL ANALOGY + MEMORY DELTA
Bottom line: investigate / track / ignore - never a blind buy.
