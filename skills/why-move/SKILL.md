...
license: MIT
name: why-move
description: Multi-dimensional investigation of a specific price move.
---
...
## Output format
Rendered EXCLUSIVELY by `trader-explainer` per `workflows/why-move.spec.yaml`.
Do not output dimension headers yourself. Dimensions without evidence are OMITTED
silently — never listed as MISSING. See trader-explainer SKILL for the exact
