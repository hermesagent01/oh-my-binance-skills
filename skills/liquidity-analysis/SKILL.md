...
description: Liquidity quality assessment: depth, spread, slippage.
---

# liquidity-analysis

How deep is the water where it matters?
...
## Method
Order book depth at +/-1% and +/-2%; spread bps;
estimated slippage for $10k and $100k orders on primary pair.

## Output contract (use these exact section headers)
LIQUIDITY
PAIR | depth +/-2% | spread bps | est slippage $10k/$100k
VERDICT: can normal size trade here without moving it?
