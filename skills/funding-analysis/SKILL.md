...
description: Use when analyzing Binance perpetual funding, crowding, or derivatives positioning.
author: Oh My Binance contributors
license: MIT
metadata:
  hermes:
    tags: [crypto, derivatives, funding, binance-agent-os]
---

# Funding analysis

### Procedure
1. Resolve symbol, contract, venue and timeframe.
2. Record current funding and funding interval from Binance Agent OS.
3. Retrieve historical funding when available.
4. Compare the current value with an asset/venue-appropriate historical distribution.
5. Combine with price, OI and liquidations when available.
6. Describe crowding pressure; never infer exact trader intent from funding alone.

### Output
`FUNDING`
- Current rate
- Interval
- Historical percentile/baseline
- Price/OI context
- Interpretation
- Missing/limitations
- Confidence

Do not use a universal funding threshold such as 0.03% = extreme.
