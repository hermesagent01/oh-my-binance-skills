...
description: Liquidation context: recent cascades and estimated clusters.
---

# liquidation-analysis

Where are liquidation clusters and what recently flushed?
...
## Method
Recent cascades from price wicks + OI drops.
Cluster estimates from leverage bands around recent levels - ALWAYS labeled as assumption.

## Output contract (use these exact section headers)
LIQUIDATIONS
RECENT EVENT: magnitude, side flushed, timeframe
CLUSTERS: estimated zones above/below (assumption-based, labeled)
READ: magnetic zones / flushed-out side
