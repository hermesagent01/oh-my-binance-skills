...
description: Morning dashboard: attention allocation, never advice.
---

# daily-intelligence (bundle)
...
## Trigger
Cron/scheduled run, or `morning brief`.
...
## Output format
CRYPTO INTELLIGENCE - DATE
MARKET: state paragraph
BIGGEST CHANGES: top 3
UNUSUAL ACTIVITY: anomalies
SMART MONEY: moves
NARRATIVES: rotation
TOP THINGS WORTH INVESTIGATING: 3, each with why
Never says BUY. Attention allocation only.
