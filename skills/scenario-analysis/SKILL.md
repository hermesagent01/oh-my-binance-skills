...
description: Structured bull/base/bear scenarios with triggers and early tells.
---

# scenario-analysis

Forward scenarios with probabilities summing ~100%.
...
## Method
From structure + derivatives state define 3 scenarios:
trigger condition, path, probability estimate, early confirming observation.

## Output contract (use these exact section headers)
SCENARIOS - $SUBJECT
BULL: trigger | path | prob | early tell
BASE: ...
BEAR: ...
KEY SWITCH: the observation telling you which world you're in
