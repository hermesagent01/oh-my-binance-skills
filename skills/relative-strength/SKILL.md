...
description: Relative performance ranking vs BTC.
---
...
## Inputs
Universe + window (default top-50, 7d)

## Method
Return vs BTC over identical window for each member.
Leaders and laggards tables; note rotation vs persistence.

## Output contract (use these exact section headers)
RELATIVE STRENGTH (vs BTC, 7d)
LEADERS: top 10 with alpha
LAGGARDS: bottom 10
NOTE: rotation vs persistence
