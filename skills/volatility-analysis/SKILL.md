...
description: Volatility conditions: squeeze vs expansion regime.
---

# volatility-analysis

Is the market coiling or expanding?
...
## Inputs
Symbol or default basket

## Method
1. ATR(14) on 4h and 1d.
2. Percentile vs last 90 days.
3. Regime call: SQUEEZING / NORMAL / EXPANDING with setup implication.

## Output contract (use these exact section headers)
VOLATILITY
SYMBOL | ATR(4h) | percentile | regime
SETUP IMPLICATION: breakout-watch vs fade regime
