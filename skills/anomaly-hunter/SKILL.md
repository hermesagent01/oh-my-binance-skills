...
license: MIT
name: anomaly-hunter
description: Searches dimensions for what is UNUSUAL right now; ranks anomalies by magnitude.
---

# anomaly-hunter (bundle)
...
## Output format
ANOMALIES - timestamp
RANKED: anomaly | dimension | magnitude (sigma or x-normal) | probable meaning
Each anomaly MUST cite its metric deviation.
NOISE FILTER: drop <2-sigma or scheduled-event explainable items
